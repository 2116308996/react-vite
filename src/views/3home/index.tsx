...
const APP = () => {
    ...
    useEffect(() => {
        ...
        const handleWheel = useThrottle((e: WheelEvent) => {
            console.log(swiperRef.current?.activeIndex, isRemoveFooter)
            ...
            if (isRemoveFooter.current == true && e.deltaY < 0 && swiperRef.current?.activeIndex == 4) {
            ...
            if (e.deltaY > 0 && isRemoveFooter.current == false) {
                // 向下滚动
    ...
    return (
        <>
            <main className='swiper-container'>
                ...
                <div className='footer' style={{ display: swiperActiveIndex == 4 ? 'none' : 'block' }}>
                    <img
